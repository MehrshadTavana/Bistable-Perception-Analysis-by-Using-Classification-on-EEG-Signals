%%%% Make sure to read the new updates in readme file this is the main file that you have to run the code
%% have a run here in the main code from the main, also do not change any part of the code here in the main here
load("epochs.mat");
load("labels.mat");
load('locs.mat');
name = cellstr(name);
...
%% for running have here not anywhere else dont forget to do that here just here make sure you have them and test the database and push to db to main
