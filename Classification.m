...
%% have a run here in the main code from the main, also do not change any part of the code here in the main here in the main in the main here in main in here here here here in main
load("epochs.mat");
load("labels.mat");
load('locs.mat');
name = cellstr(name);
...
%% for running have here not anywhere else dont forget to do that here just here make sure you have them and test the database and push to db to main here in the main in here in main
