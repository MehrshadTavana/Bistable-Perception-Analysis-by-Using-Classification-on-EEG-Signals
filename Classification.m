...
%% have a run here in the main code from the main, also do not change any part of the code here in the main here in the main in the main here in main in here here here
load("epochs.mat");
load("labels.mat");
load('locs.mat');
name = cellstr(name);
